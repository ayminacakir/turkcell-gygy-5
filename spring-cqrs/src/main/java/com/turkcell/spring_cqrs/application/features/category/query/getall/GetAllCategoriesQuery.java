...
// 1- JWT yapısına ve UserContext yapısına rol mantığı eklenecek. (Her request
// dilerse rol gerektirebilir -> Role listesi dooldurulursa rolelerde kontrol
// edilmeli)
// 2- Auth hataları kendine has exceptionlar fırlatmalı.
// (AuthenticatedException,AuthorizationException)
