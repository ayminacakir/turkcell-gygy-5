...
public class AuthorizationBehavior implements PipelineBehavior {
    ...
    public <R> R handle(Object request, RequestHandlerDelegate<R> next) {
        if (!userContext.isAuthenticated()) // kullanıcı giriş yapmamışsa
            throw new RuntimeException("Giriş yapmalısın..");
        // Özel bir exception türü belirle.
        // Handlerda bu exceptionı eğer giriş yapılmamışsa 401,
        // (UnauthenticatedException)
        // yapılmış ancak rol yetersiz ise 403 döndürecek şekilde
