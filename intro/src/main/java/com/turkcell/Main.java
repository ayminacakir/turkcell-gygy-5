...
public class Main {
    public static void main(String[] args) {
        ...
        int[] c = { 0, 1, 2, 3 };
        int[] d = c; // d → c'nin gösterdiği yere bak
        d[3] = 30; // Array’ler referans tiptir, eşitleme yapılırsa kopya değil adres paylaşılır.
        System.out.println(c[3]); // d ve c aynı referansı tutuyor
        System.out.println(d[3]);

        System.out.println("******");

        System.out.println(a == b);
        System.out.println(c == d); /* int, double değeri kopyalar array, object adresi kopyalar */

        int[] x = { 0, 1, 2, 3 };
        int[] y = { 0, 1, 2, 3 };
        System.out.println(y);
        System.out.println(x == y); // adres karşılaştırır (false)
        System.out.println(Arrays.equals(x, y)); // içerik karşılaştır. (true)

        String s1 = "Merhaba";
        String s2 = "Merhaba";
        System.out.println(s1 == s2); // String Pool : Aynı değer olduğu için aynı adresi gösterir
        /*
         * Java, aynı stringleri tekrar tekrar oluşturmamak için
         * String Pool (havuz) kullanır.
         * 
         * Aynı değer → aynı referans (adres)
         */
        // (Aynı metinlerin bir havuzda toplanıp performans için birebir olanları aynı
        // referansa ata.) Değerleri aynı olan string değişkenlere aynı adresi veriyor.

        // Yine de daha güvenli bir karşılaştırma için equals() kullanılır.equals():
        // değer karşılaştırır (her zaman güvenli)
        System.out.println(s1.equals(s2));

        String s3 = "Turkcell";
        String s4 = s3.intern();
        // intern() metodu, s3'ün değerini String Pool'a ekler ve oradaki referansı
        // döndürür.
        ...
        /*
         * string immutable demiştik ama
         * String name = "Halit";
         * System.out.println(name);
         * name = "25";
         * System.out.println(name); burada farklı yazıyor “
         * 
         * String immutable’dır; değişiklik yapıldığında mevcut nesne değişmez, yeni bir
         * nesne oluşturulup referans ona yönlendirilir.”
         * String değişmiyor ama eski hali nerde tutuluyor?”Heap memory içinde,
         * özellikle String Pool’da tutuluyor.
         * Eski string silinmez, hafızada durur .Hiçbir değişken onu göstermiyorsa
         * Garbage Collector (çöp toplayıcı) gelip temizle
         */
        ...
        for (String z : students) { // students dizisindeki her elemanı sırayla al → String z’ye koy → çalıştır
    ...
    public static double sum(double... numbers) { // varargs(sınırsız sayıda istediğin kadar paramaetre gönder)
        double total = 0;
