...
/* Spring uygulama ayağa kalkarken bunu görür ve der ki:“Tamam, ben bu class’tan
* bir nesne oluşturup container’a koyayım.”ApplicationContext ise Spring’in
* bean kutusu gibi düşünebilirsin.*/
@Component
public class SpringMediator implements Mediator {
    ...
    private <R> R invokePipeline(Object request, RequestHandlerDelegate<R> handlerInvocation) {
        ...
        for (int i = behaviors.size() - 1; i >= 0; i--) // behaviorları tek tek dolaşıyorum .Sıraya göre tersten
                                                        // Behaviorları çağır.
        {
            PipelineBehavior behavior = behaviors.get(i); // behaviorları sıraya göre çağırır.
